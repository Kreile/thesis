...
correlation.cont <- meta.cont %>% ungroup() %>% summarise(tes.d.egger = cor(pval.egger, pval.d.tes),
																													thompson.tes.d = cor(pval.thompson, pval.d.tes),
																													tes.d.begg = cor(pval.d.tes, pval.begg),
																													thompson.egger = cor(pval.thompson, pval.egger),
																													thompson.begg = cor(pval.thompson, pval.begg),
																													egger.begg = cor(pval.egger, pval.begg))
rsquared.cont <- meta.cont %>% ungroup() %>% summarise(tes.d.egger = summary(lm(pval.egger~ pval.d.tes))$r.squared,
                                                          thompson.tes.d = summary(lm(pval.thompson~ pval.d.tes))$r.squared,
                                                          tes.d.begg = summary(lm(pval.d.tes~ pval.begg))$r.squared,
                                                          thompson.egger = summary(lm(pval.thompson~ pval.egger))$r.squared,
...
agreement.surv <- meta.surv %>% ungroup() %>%  summarise(tes.d.egger = sum(tes.d.egger == "agree")/n(),
                                                         ...
                                                         thompson.begg = sum(thompson.begg == "agree")/n(),
                                                         egger.begg = sum(egger.begg == "agree")/n())
correlation.surv <- meta.surv %>% ungroup() %>% summarise(tes.d.egger = cor(pval.egger, pval.d.tes),
																													thompson.tes.d = cor(pval.thompson, pval.d.tes),
																													tes.d.begg = cor(pval.d.tes, pval.begg),
																													thompson.egger = cor(pval.thompson, pval.egger),
																													thompson.begg = cor(pval.thompson, pval.begg),
																													egger.begg = cor(pval.egger, pval.begg))
rsquared.surv <- meta.surv %>% ungroup() %>% summarise(tes.d.egger = summary(lm(pval.egger~ pval.d.tes))$r.squared,
                                                          thompson.tes.d = summary(lm(pval.thompson~ pval.d.tes))$r.squared,
                                                          tes.d.begg = summary(lm(pval.d.tes~ pval.begg))$r.squared,
                                                          thompson.egger = summary(lm(pval.thompson~ pval.egger))$r.squared,
                                                          thompson.begg = summary(lm(pval.thompson~ pval.begg))$r.squared,
...
%Figures \ref{fig:test.bin}, \ref{fig:test.cont} and \ref{fig:test.surv}. 
...
adjustment.diff <- meta.f %>% 
  ...
  transmute(copas.z.f = est.z.copas.f - est.z.fixef,
            copas.z.r = est.z.copas.r - est.z.ranef,
            reg.z.f = est.z.reg.f - est.z.fixef,
            reg.z.r = est.z.reg.r - est.z.ranef,
            
            copas.d.f = est.d.copas.f - est.d.fixef,
            copas.d.r = est.d.copas.r - est.d.ranef,
            reg.d.f = est.d.reg.f - est.d.fixef,
            reg.d.r = est.d.reg.r - est.d.ranef) 
...
adjustmend.diff.surv <- meta.surv %>% 
  ...
  transmute(copas.surv.f = est.copas.f - est.fixef,
            copas.surv.r = est.copas.r - est.ranef,
            
            reg.surv.f = est.reg.f - est.fixef,
            reg.surv.r = est.reg.r - est.ranef) 
...
%For sake of interpretability, negative effect sizes are changed to positive, such that a negative difference always means that the adjusted treatment effect is larger than the meta-analysis effect. Vice versa, a positive difference will indicate smaller adjusted effects. \\
