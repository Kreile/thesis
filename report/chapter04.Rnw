...
print(xtable(missing.differences, 
             caption = "Missing meta-analysis combined treatment effect and adjusted treatment effects. Abbreviations are used for z-score (= z) and std. mean difference (= d).", label = "missing.differences", align = "lcccrrrrrrrr"), 
