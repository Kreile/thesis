...
diff.log.hazard.ratio.fixef <- meta.surv %>% 
  ...
  facet_wrap(~method) + theme_bw() + xlab("Fixed effects - adjusted log hazard ratio") + geom_vline(xintercept = 0, linetype = "dashed" )
#--------------------------------------------------------------------------------------------------------------------#
...
diff.log.hazard.ratio.ranef <- meta.surv %>% 
  ...
  geom_histogram(binwidth = 0.1, center = 0) +
  facet_wrap(~method) + theme_bw() + xlab("Random effects - adjusted log hazard ratio") + geom_vline(xintercept = 0, linetype = "dashed" )
#--------------------------------------------------------------------------------------------------------------------#
