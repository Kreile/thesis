...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in mly.cont(data.ext, 0.05, min.study.number = 2): could not find function "{}mly.cont"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in mly.bin(data.ext, 0.05, min.study.number = 2): could not find function "{}mly.bin"{}}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in readChar(con, 5L, useBytes = TRUE): cannot open compressed file '/Users/p.galiot/PubBias/results/mly.RData', probable reason 'No such file or directory'}}
