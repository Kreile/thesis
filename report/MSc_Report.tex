...
The same is shown in Figure \ref{bias.results.bin} for dichotomous outcome measures ($n$ = 3350).
...
\begin{tabular}{lll}
 ...
 & Test Agreement & P-value Correlation \\ 
  \hline
egger.schwarzer & 0.88 & 0.38 \\ 
  egger.peter & 0.89 & 0.52 \\ 
  egger.rucker & 0.89 & 0.48 \\ 
  egger.harbord & 0.94 & 0.76 \\ 
  schwarzer.peter & 0.89 & 0.29 \\ 
  schwarzer.rucker & 0.88 & 0.34 \\ 
  schwarzer.harbord & 0.92 & 0.51 \\ 
  rucker.peter & 0.92 & 0.67 \\ 
  harbord.peter & 0.91 & 0.53 \\ 
   \hline
\end{tabular}
\endgroup
